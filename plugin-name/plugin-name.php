...
use Company\Plugin_Name\Inc\i18n;
use Company\Plugin_Name\Inc\Admin;
use Company\Plugin_Name\Inc\Frontend;
...
class Plugin {
  ...
  protected $support;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once $this->plugin_path . 'includes/loader.class.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once $this->plugin_path . 'includes/i18n.class.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once $this->plugin_path . 'includes/admin.class.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once $this->plugin_path . 'includes/frontend.class.php';
